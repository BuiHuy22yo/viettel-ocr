...
<script lang="ts" setup>
  ...
  import ContractTermDrawer from './ContractAttributeValueTypeDrawer.vue';

  import { columns } from './contractAttributeValueType.data';
  import { message } from 'ant-design-vue';
  import { useI18n } from '@/hooks/web/useI18n';

  defineOptions({ name: 'ContractAttributeValueType' });
  ...
  const [registerTable, { setLoading }] = useTable({
    title: t('form.setting.contractAttributeValueType'),
    dataSource: dataSource,
    subTitle: t('form.setting.subTitleContractAttributeValueType'),
    icon: 'iconamoon:type-fill',
    columns,
    bordered: true,
