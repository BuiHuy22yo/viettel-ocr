      ...
      <template #toolbar>
        <div class="flex">
          ...
          <a-button type="primary" @click="handleCreate" class="ml-5"
            ...
            {{ t('serviceRequest.purpose_setting.modalAddTitle') }}
          </a-button>
        </div>
      </template>
...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'Purpose of Request' });
  ...
  const [registerTable, { setLoading }] = useTable({
    title: t('serviceRequest.purpose_setting.title'),
    dataSource: dataSource,
    subTitle: t('serviceRequest.purpose_setting.subTitle'),
