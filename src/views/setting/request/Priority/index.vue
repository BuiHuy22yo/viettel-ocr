      ...
      <template #toolbar>
        <div class="flex">
          ...
          <a-button type="primary" @click="handleCreate" class="ml-5"
            ...
            {{ t('serviceRequest.priority_setting.modalAddTitle') }}
          </a-button>
        </div>
      </template>
...
<script lang="ts" setup>
  ...
  import OrgDrawer from './PriorityDrawer.vue';

  import { columns } from './Priority.data';
  ...
  const [registerTable, { setLoading }] = useTable({
    title: t('serviceRequest.priority_setting.title'),
    dataSource: dataSource,
    subTitle: t('serviceRequest.priority_setting.subTitle'),
