...
<script lang="ts" setup>
  ...
  import { createParameter, updateParameter } from '@/api/setting/policy';
  ...
  const getTitle = computed(() =>
    !unref(isUpdate)
      ? t('form.setting.createExtendedParameter')
      : t('form.setting.updateExtendedParameter'),
  );
  ...
  async function handleSubmit() {
    try {
      ...
      !unref(isUpdate)
        ...
        : await updateParameter({ ...dataRecord.value, ...values });
      closeDrawer();
