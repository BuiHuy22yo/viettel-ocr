...
<script lang="ts" setup>
  ...
  import { createCompany, updateCompany } from '@/api/setting/org';
  ...
  const getTitle = computed(() =>
    !unref(isUpdate) ? t('form.setting.createCompany') : t('form.setting.updateCompany'),
  );
  ...
  async function handleSubmit() {
    try {
      ...
      !unref(isUpdate)
        ...
        : await updateCompany({ ...dataRecord.value, ...values });
      closeDrawer();
