...
<script lang="ts" setup>
  ...
  import { createUnit, updateUnit } from '@/api/setting/org';
  ...
  const getTitle = computed(() =>
    !unref(isUpdate) ? t('form.setting.createUnit') : t('form.setting.updateUnit'),
  );
  ...
  async function handleSubmit() {
    try {
      ...
      !unref(isUpdate)
        ...
        : await updateUnit({ ...dataRecord.value, ...values });
      closeDrawer();
