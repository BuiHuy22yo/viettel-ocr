...
<script lang="ts" setup>
  ...
  import { createDataSource, updateDataSource } from '@/api/setting/income';
  ...
  const getTitle = computed(() =>
    !unref(isUpdate)
      ? t('form.setting.createExtraDataTable')
      : t('form.setting.updateExtraDataTable'),
  );
  ...
  async function handleSubmit() {
    try {
      ...
      !unref(isUpdate)
        ...
        : await updateDataSource({ ...dataRecord.value, ...values });
      closeDrawer();
