...
import { getAllMethod } from '@/api/setting/income';
...
export const columns: BasicColumn[] = [
  {
    ...
    dataIndex: 'incomeDataSourceCode',
    width: 250,
  },
  {
    title: t('form.setting.name'),
    dataIndex: 'incomeDataSourceName',
    width: 250,
  },
  {
...
export const formSchema: any = [
  {
    field: 'incomeDataSourceName',
    label: t('form.setting.name'),
    required: true,
    component: 'Input',
  },
  {
    field: 'incomeDataSourceCode',
    label: t('form.setting.code'),
    required: true,
    component: 'Input',
  },
  {
    field: 'incomeMethodId',
    label: t('form.setting.method'),
    component: 'ApiSelect',
    required: true,
