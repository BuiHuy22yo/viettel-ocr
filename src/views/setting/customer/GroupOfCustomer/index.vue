...
<script lang="ts" setup>
  ...
  import GroupCustomerDrawer from './GroupCustomerDrawer.vue';

  import { columns } from './groupCustomer.data';
  import { message } from 'ant-design-vue';
  import { useI18n } from '@/hooks/web/useI18n';

  defineOptions({ name: 'TypeOfCustomer' });
  ...
  const [registerTable, { setLoading }] = useTable({
    title: t('form.setting.groupCustomer'),
    dataSource: dataSource,
    subTitle: t('form.setting.subTitleGroupCustomer'),
    columns,
    bordered: true,
