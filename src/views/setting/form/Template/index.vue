...
<script lang="ts" setup>
  ...
  import { copyTemplate, deleteTemplate, getAllTemplate } from '@/api/setting/template';
  ...
  async function copy(record: Recordable) {
    try {
      setLoading(true);
      await copyTemplate({ templateId: record.id });
      searchAllTemplate('');
    } finally {
      setLoading(false);
    }
