<template>
  <div>
    ...
    <variantGroupAttributeDrawer @register="registerDrawer" @success="handleSuccess" />
    <AModal
...
<script lang="ts" setup>
  ...
  import variantGroupAttributeDrawer from './variantGroupAttributeDrawer.vue';

  import { columns } from './data';
  import {
    deleteVariantGroupAttribute,
  ...
  async function searchAllProductAttribute(text: string) {
    try {
      setLoading(true);
      const data: any = await getAllVariantGroupAttribute({
        keyword: text,
      });
  ...
  const handleOk = async () => {
    try {
      ...
      await deleteVariantGroupAttribute({ id: id.value });
      searchAllProductAttribute(textSearch.value);
