...
<script lang="ts" setup>
  ...
  import { createService, updateService } from '@/api/setting/service-product';
  ...
  const getTitle = computed(() =>
    !unref(isUpdate) ? t('form.setting.createService') : t('form.setting.updateService'),
  );
  ...
  async function handleSubmit() {
    try {
      ...
      !unref(isUpdate)
        ...
        : await updateService({ ...dataRecord.value, ...values });
      closeDrawer();
