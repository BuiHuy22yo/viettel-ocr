...
import { getAllGroupIndicator } from '@/api/setting/service-product';
...
export const columns: BasicColumn[] = [
  ...
  },
  {
    ...
    dataIndex: 'productGroupIndicatorName',
    width: 300,
  },
  {
    width: 160,
...
export const formSchema: any = [
  ...
  {
    field: 'productGroupIndicatorId',
    label: t('form.setting.groupIndicator'),
    required: true,
    component: 'ApiSelect',
    componentProps: ({ formModel }) => {
      return {
        api: getAllGroupIndicator,
        valueField: 'id',
