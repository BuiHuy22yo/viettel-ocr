...
<script lang="ts" setup>
  ...
  import { createDomain, updateDomain } from '@/api/setting/resources';
  ...
  const getTitle = computed(() =>
    !unref(isUpdate) ? t('form.setting.createDomain') : t('form.setting.updateDomain'),
  );
  ...
  async function handleSubmit() {
    try {
      ...
      !unref(isUpdate)
        ...
        : await updateDomain({ ...dataRecord.value, ...values });
      closeDrawer();
