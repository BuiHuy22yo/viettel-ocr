...
<script lang="ts" setup>
  ...
  import { getAllArea, getWardByDistrict } from '@/api/setting/location';
  ...
  import OrgDrawer from './WardDrawer.vue';

  import { columns } from './ward.data';
  ...
  const [registerTable, { setLoading }] = useTable({
    title: t('form.setting.commune'),
    dataSource: dataSource,
    subTitle: t('form.setting.subTitleCommune'),
  ...
  async function searchAllCompany(text: string) {
    try {
      setLoading(true);
      const data: any = await getWardByDistrict({ keyword: text });
