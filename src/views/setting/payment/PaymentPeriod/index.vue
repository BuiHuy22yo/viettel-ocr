      ...
      <template #toolbar>
        <div class="flex">
          ...
          <a-button type="primary" @click="handleCreate" class="ml-5">
            <Icon :icon="'ion:add-outline'" /> {{ t('paymentSetting.paymentPeriod.addButton') }}
          </a-button>
        </div>
      </template>
...
<script lang="ts" setup>
  ...
  const [registerTable, { setLoading }] = useTable({
    title: t('paymentSetting.paymentPeriod.title'),
    dataSource: dataSource,
    subTitle: t('paymentSetting.paymentPeriod.subTitle'),
