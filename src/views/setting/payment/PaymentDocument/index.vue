      ...
      <template #toolbar>
        <div class="flex">
          ...
          <a-button type="primary" @click="handleCreate" class="ml-5">
            <Icon :icon="'ion:add-outline'" /> {{ t('paymentSetting.paymentDocument.addButton') }}
          </a-button>
        </div>
      </template>
...
<script lang="ts" setup>
  ...
  const [registerTable, { setLoading }] = useTable({
    title: t('paymentSetting.paymentDocument.title'),
    dataSource: dataSource,
    subTitle: t('paymentSetting.paymentDocument.subTitle'),
