      ...
      <template #toolbar>
        <div class="flex">
          ...
          <a-button type="primary" @click="handleCreate" class="ml-5">
            <Icon :icon="'ion:add-outline'" /> {{ t('paymentSetting.paymentDebtAge.addButton') }}
          </a-button>
        </div>
      </template>
...
<script lang="ts" setup>
  ...
  const [registerTable, { setLoading }] = useTable({
    title: t('paymentSetting.paymentDebtAge.title'),
    dataSource: dataSource,
    subTitle: t('paymentSetting.paymentDebtAge.subTitle'),
