export default {
  paymentPeriod: {
    ...
    subTitle: 'Định nghĩa các chu kỳ thanh toán của Mobifone',
    addButton: 'Thêm chu kỳ thanh toán',
    createPeriod: 'Thêm chu kỳ thanh toán',
    updatePeriod: 'Cập nhật chu kỳ thanh toán',
  },
  paymentDebtAge: {
    title: 'Tuổi nợ',
