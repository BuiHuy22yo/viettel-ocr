...
import { PermissionModeEnum, PermissionPrefixEnum } from '@/enums/appEnum';
...
export function usePermission() {
  ...
  function hasPermission(value?: RoleEnum | RoleEnum[] | string | string[], def = true): boolean {
    ...
    //       userStore.getPermissions?.includes(value as string) ||
    //       userStore.getPermissions?.includes(PermissionPrefixEnum.READ.concat(value as string))
    //     );
    //   }
    ...
    //   const allCodeList = permissionStore.getPermissionMenuList as string[];
    //   if (!isArray(value)) {
    //     const splits = ['||', '&&'];
