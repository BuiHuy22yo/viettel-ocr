  ...
  return [
    {
      ...
      customRender: ({ record }) => {
        ...
        return isImgTypeByName(record.name) && <ThumbUrl fileUrl={url} />;
      },
    },
    {
      dataIndex: 'name',
...
export function createPreviewColumnsNotViewImg(): BasicColumn[] {
  return [
    {
      dataIndex: 'name',
      title: t('component.upload.fileName'),
...
export function createPreviewActionColumn({ handleRemove, handleDownload, handleView }, isView) {
  return {
    width: 160,
    title: t('component.upload.operating'),
    dataIndex: 'action',
