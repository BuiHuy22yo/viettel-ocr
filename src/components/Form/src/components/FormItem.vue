  ...
  export default defineComponent({
    ...
    setup(props, { slots }) {
      ...
      return () => {
        ...
        const opts = { disabled: unref(getDisable), readonly: unref(getReadonly) };
        const isHiddenContent = !!unref(getComponentsProps)?.isHiddenContent;
        const isHidden = !!unref(getComponentsProps)?.isHidden;
        ...
        return (
          ...
          !isHidden && (
            <Col {...realColProps} v-show={isShow}>
              <span v-show={!isHiddenContent}>{getContent()}</span>
            </Col>
          )
        );
      };
