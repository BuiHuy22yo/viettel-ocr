...
type ExtendedInputNumberProps = ExtractPropTypes<
  (typeof import('ant-design-vue/es/input-number'))['default']
> & {
...
interface _CustomComponents {
  ...
  >;
  UploadTransport: ExtractPropTypes<
    (typeof import('@/components/UploadTransport/src/BasicUpload.vue'))['default']
  >;
  ImageUploadTransport: ExtractPropTypes<
    (typeof import('@/components/UploadTransport/src/components/ImageUpload.vue'))['default']
  >;
  ...
  >;
  InputNumberCustom: ExtractPropTypes<
    (typeof import('@/components/Form/src/components/InputNumberCustom.vue'))['default']
  >;
}
...
export interface ComponentProps {
  ...
  InputNumberCustom: CustomComponents['InputNumberCustom'] & ComponentProps['InputNumber'];
  ...
  UploadTransport: CustomComponents['UploadTransport'];
  ImageUploadTransport: CustomComponents['ImageUploadTransport'];
