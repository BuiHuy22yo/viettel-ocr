...
import { BasicUpload, ImageUpload } from '@/components/UploadTransport';
...
componentMap.set('ImageUploadTransport', ImageUpload);
...
componentMap.set('InputNumberCustom', InputNumberCustom);
...
componentMap.set('UploadTransport', BasicUpload);
